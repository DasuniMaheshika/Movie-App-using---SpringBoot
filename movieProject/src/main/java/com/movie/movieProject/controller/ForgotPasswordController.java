...
import com.movie.movieProject.auth.repository.ForgotPasswordRepository;
import com.movie.movieProject.auth.repository.UserRepository;
import com.movie.movieProject.auth.utils.ChangePassword;
import com.movie.movieProject.dto.MailBody;
import com.movie.movieProject.service.EmailService;
...
public class ForgotPasswordController {
    ...
    public ResponseEntity<String> verifyEmail(@PathVariable String email) {
        User user = userRepository.findByEmail(email).orElseThrow(() -> new UsernameNotFoundException("Please provide an valid email!" + email));
